  ...
  return {
    ...
    '& .react-datepicker': {
      ...
      '& .react-datepicker__day--in-range, & .react-datepicker__day--in-selecting-range': {
        ...
        backgroundColor: `${hexToRGBA(theme.palette.secondary.dark, 0.06)} !important`,
      },
      '& .react-datepicker__day--today': {
        ...
        '&:not(.react-datepicker__day--selected):not(:empty)': {
          ...
          '&:hover': {
            backgroundColor: hexToRGBA(theme.palette.secondary.dark, 0.04),
          },
          '&.react-datepicker__day--keyboard-selected': {
            backgroundColor: hexToRGBA(theme.palette.secondary.dark, 0.06),
      ...
      '& .react-datepicker__day--keyboard-selected': {
        '&:not(.react-datepicker__day--in-range)': {
          ...
          backgroundColor: `${theme.palette.secondary.dark} !important`,
          '&:hover': {
            backgroundColor: `rgba(${theme.palette.commonColor.main}, 0.06)`,
          },
        },
        // '&.react-datepicker__day--in-range:not(.react-datepicker__day--range-end)': {
        //   backgroundColor: `${hexToRGBA(theme.palette.secondary.dark, 0.12)} !important`,
        //   '&:hover': {
        //     backgroundColor: `${hexToRGBA(theme.palette.secondary.dark, 0.12)} !important`,
        //   },
        // },
      ...
      '& .react-datepicker__header__dropdown': {
        ...
        '& .react-datepicker__month-option.react-datepicker__month-option--selected_month': {
          backgroundColor: hexToRGBA(theme.palette.secondary.dark, 0.08),
          '&:hover': {
            backgroundColor: hexToRGBA(theme.palette.secondary.dark, 0.12),
          },
        ...
        '& .react-datepicker__year-option': {
          ...
          '& .react-datepicker__navigation--years-upcoming': {
            ...
            margin: `${theme.spacing(0.5)} auto ${theme.spacing(0)}`,
          },
          ...
          '& .react-datepicker__navigation--years-previous': {
            ...
            margin: `${theme.spacing(0)} auto ${theme.spacing(0.5)}`,
          },
